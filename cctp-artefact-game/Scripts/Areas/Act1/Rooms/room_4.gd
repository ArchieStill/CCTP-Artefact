...
@onready var battlecol: CollisionShape2D = $Battle2/Collision


func _ready() -> void:
	Global.InDialogue = false
	anim.play("fade_in")
	if Events.OneEvents == 3:
...
func _on_anim_animation_finished(anim_name: StringName) -> void:
	if anim_name == "fade_in":
		if Events.ACT2:
			...
			DialogueManager.show_dialogue_balloon(load("res://Dialogue/Narrator/NarratorR4.dialogue"))
	if anim_name == "fade_out":
		get_tree().change_scene_to_file("res://Scenes/Combat/Battles/Act1/Battle2.tscn")
